#ifndef HAL_ZYNQ_UART_H_		/* prevent circular inclusions */
#define HAL_ZYNQ_UART_H_		/* by using protection macros */
...
#define XUARTPS_BASE_ADDRESS0       0xE0000000
#define XUARTPS_INTERRUPT0          59
